...
/**
* Classe de Interface de usuÃ¡rio. As interfaces implementadas nesse projeto sÃ£o simples com contato por terminal com o
* usuÃ¡rio. Elas se comunicam com as classes de negÃ³cio para lÃ³gica de manejamento de dados.
* <p>
* A classe IuEstante possui todos os mÃ©todos de interaÃ§Ã£o com o usuÃ¡rio relativos Ã  estante. SÃ£o eles: adicionar livro 
* na estante, remover livro da estante, consultar dados de livro, consultar usuÃ¡rio, escrever resenha de livro e 
...
class IuEstante{
	...
	/**
	* MÃ©todo que mostra a estante do usuÃ¡rio. Depois mostra um menu com as opÃ§Ãµes que o usuÃ¡rio pode 
	* fazer com a estante.
	*
	* @param p 			a pessoa cuja estante serÃ¡ mostrada
